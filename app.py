...
def add():
    if request.method == 'POST':
        ...
        cursor.execute("INSERT INTO tools(name, box_number, year_of_acquisition, quantity, quantity_type, cost, owner, manufacturer_link, equipment_supply, link_to_image, link_to_video, link_to_acquisition_form, course) VALUES({}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {})".format(tool, box_number, year_of_acquisition, quantity, quantity_type, cost, owner, manufacturer_link, equipment_supply, link_to_image, link_to_video, link_to_acquisition_form, course))
        connection.commit()
